...
const HobbiesIdoso: React.FC<HobbiesIdosoProps> = ({ 
  ...
  const [interesses, setInteresses] = useState({
    ...
    praticaEsporte: {
      pratica: data.interesses?.praticaEsporte?.pratica || false,
      quais: data.interesses?.praticaEsporte?.quais || '',
    },
    atividadesManuais: {
    ...
    interesseAprender: {
      interessado: data.interesses?.interesseAprender?.interessado || false,
      oque: data.interesses?.interesseAprender?.oque || '',
    },
    prefCulturais: {
  ...
  const handlePraticaEsporte = (value: boolean) => {
    setInteresses(prev => ({
      ...prev,
      praticaEsporte: {
        ...prev.praticaEsporte,
  ...
  const handleQuaisPraticaEsporte = (e: React.ChangeEvent<HTMLInputElement>) => {
    setInteresses(prev => ({
      ...prev,
      praticaEsporte: {
        ...prev.praticaEsporte,
  ...
  const handleInteresseAprender = (value: boolean) => {
    setInteresses(prev => ({
      ...prev,
      interesseAprender: {
        ...prev.interesseAprender,
        interessado: value
      }
    }));
  };

  const handleOqueInteresseAprender = (e: React.ChangeEvent<HTMLInputElement>) => {
    setInteresses(prev => ({
      ...prev,
      interesseAprender: {
        ...prev.interesseAprender,
    ...
    <form onSubmit={handleFormSubmit} className="space-y-8">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            <p className="mb-2 font-medium">2. Você pratica algum esporte ou atividade física regularmente?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
                  name="pratica-esporte"
                  checked={interesses.praticaEsporte.pratica === true}
                  onChange={() => handlePraticaEsporte(true)}
                />
                <span>Sim</span>
              </label>
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
                  name="pratica-esporte"
                  checked={interesses.praticaEsporte.pratica === false}
                  onChange={() => handlePraticaEsporte(false)}
                />
                <span>Não</span>
              </label>
              {interesses.praticaEsporte.pratica && (
                <div className="mt-2">
                  <label htmlFor="quais-esportes" className="block">Se sim, qual(is) atividade(s)?</label>
                  <input
                    type="text"
                    id="quais-esportes"
                    value={interesses.praticaEsporte.quais}
                    onChange={handleQuaisPraticaEsporte}
          ...
          <div>
            <p className="mb-2 font-medium">3. Você gosta de atividades manuais, como tricô, crochê ou trabalhos com madeira?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
          ...
          <div>
            <p className="mb-2 font-medium">4. Tem interesse em aprender algo novo?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
                  name="interesse-aprender"
                  checked={interesses.interesseAprender.interessado === true}
                  onChange={() => handleInteresseAprender(true)}
                />
                <span>Sim</span>
              </label>
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
                  name="interesse-aprender"
                  checked={interesses.interesseAprender.interessado === false}
                  onChange={() => handleInteresseAprender(false)}
                />
                <span>Não</span>
              </label>
              {interesses.interesseAprender.interessado && (
                <div className="mt-2">
                  <label htmlFor="oque-aprender" className="block">Se sim, o quê?</label>
                  <input
                    type="text"
                    id="oque-aprender"
                    value={interesses.interesseAprender.oque}
                    onChange={handleOqueInteresseAprender}
                    className="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md mt-1"
                  />
                </div>
              )}
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="generosMusicais" className="block font-medium mb-1">
              5. Quais são os seus gêneros musicais ou artistas favoritos?
            </label>
            <Textarea
              id="generosMusicais"
          ...
          <div>
            <label htmlFor="filmesTV" className="block font-medium mb-1">
              6. Quais são os tipos de filmes ou programas de TV que você mais gosta de assistir?
            </label>
            <Textarea
              id="filmesTV"
          ...
          <div>
            <p className="mb-2 font-medium">7. Você gosta de participar de atividades sociais ou eventos, como encontros ou grupos de convivência?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
        ...
        <div className="space-y-4">
          <div>
            <p className="mb-2 font-medium">8. Você gosta de ensinar algo para os outros, como habilidades ou conhecimentos que você tem?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
          ...
          <div>
            <p className="mb-2 font-medium">9. Você se interessa por atividades que envolvam tecnologia (como uso de computador, internet ou dispositivos móveis)?</p>
            <div className="space-y-1">
              <label className="flex items-center space-x-2">
                <input 
                  type="radio" 
        ...
        <div>
          <label htmlFor="comentarios" className="block font-medium mb-1">
            10. Existe algum hobby ou interesse que você gostaria de compartilhar ou que você gostaria de tentar no futuro?
          </label>
          <Textarea
            id="comentarios"
